...
export const ProductDetails = () => {
  ...
  useEffect(() => {
    if (cartItemAddStatus === "fulfilled") {
      ...
      toast.error(
        "Có lỗi khi thêm sản phẩm vào giỏ hàng, vui lòng thử lại sau"
      );
    }
  }, [cartItemAddStatus]);
  ...
  useEffect(() => {
    if (wishlistItemAddStatus === "fulfilled") {
      ...
      toast.error(
        "Có lỗi khi thêm sản phẩm vào danh sách yêu thích, vui lòng thử lại sau"
      );
    }
  ...
  useEffect(() => {
    if (wishlistItemDeleteStatus === "fulfilled") {
      ...
      toast.error(
        "Có lỗi khi xóa sản phẩm khỏi danh sách yêu thích, vui lòng thử lại sau"
      );
    }
  ...
  useEffect(() => {
    if (productFetchStatus === "rejected") {
      toast.error(
        "Có lỗi khi tải thông tin chi tiết sản phẩm, vui lòng thử lại sau"
      );
    }
  }, [productFetchStatus]);
              ...
              >
                ...
                <Stack rowGap={"1.5rem"} width={is480 ? "100%" : "25rem"}>
                  ...
                  <Stack rowGap={".5rem"}>
                    ...
                    {/* price */}
                    <Typography variant="h5">{formatVNDComma(product?.price)}</Typography>
                  </Stack>
                  ...
                  >
                    ...
                    >
                      ...
                      <Stack>
                        ...
                        <Typography>
                          Nhập mã bưu chính của bạn để biết tình trạng giao hàng
                        </Typography>
                      </Stack>
                    </Stack>
                    <hr style={{ width: "100%" }} />
