...
export const Cart = ({checkout}) => {
    ...
    useEffect(()=>{
        if(cartItemRemoveStatus==='fulfilled'){
            ...
            toast.error("Có lỗi khi xóa sản phẩm khỏi giỏ hàng, vui lòng thử lại sau")
        }
            ...
            <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'}>

                {
                    checkout?(
                        ...
                        <>
                            <Stack>
                                <Typography variant='h6' fontWeight={500}>Tổng cộng</Typography>
                                <Typography>Tổng số mặt hàng trong giỏ hàng {totalItems}</Typography>
                                <Typography variant='body1' color={'text.secondary'}>Phí vận chuyển và thuế sẽ được tính khi thanh toán.</Typography>
                            </Stack>
